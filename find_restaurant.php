		    ...
		    <div class="container">
				<div class="banner-info">
					...
					<div class="form-list wow fadeInRight" data-wow-delay="0.5s">
						<form action="restaurant_results.php" method="post">
						  <ul class="navmain">
							<li><span>Location Name</span>
							 <input type="text" name="rlocation" class="text" value="Kanjirapally" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Kanjirapally';}">
							</li>
							
							<li><span>Cuisine Name</span>
							 <input type="text" name="rfood" class="text" value="Chicken Biriyani" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Chicken Biriyani';}">
						    </li>
						   <li><input type="submit" name="rsubmit" value="Search"></li>
						  </ul>
						</form>
						</div>
					<!-- start search-->
