		...
		<ul id="demo1">
			<li>
				...
				<div class="slide-desc">
					<h3>Find and buy what’s growing in your neighbourhood</h3>
				</div>
			</li>
			<li>
				<img src="images/22.jpg" alt="" />
				  <div class="slide-desc">
					<h3>Grow,Share and Sell</h3>
				</div>
			</li>
			...
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><em class="fa fa-arrow-right" aria-hidden="true"></em><a href="faq.php">FAQ's</a></li>
